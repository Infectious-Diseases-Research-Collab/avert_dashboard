...
const ENROLLEE_COLS =
  "uniqueid,country,subjid,barcode,mrc,village,startdate,enrollment_week,dob," +
...
export default async function DashboardPage() {
  ...
  const [facilitiesRes, enrolleeRes, bloodRes, coverageRes, issuesRes] = await Promise.all([
